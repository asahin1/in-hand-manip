...
public:
  ...
  bool friction_getter(gripper_controls::GetFriction::Request &req, gripper_controls::GetFriction::Response &res){
    res.left_friction = l_finger_friction;
    res.right_friction = r_finger_friction;
    return 1;
  }
...
int main(int argc, char **argv){
  ...
  ros::ServiceServer service_get_friction = n.advertiseService("get_friction", &LowLvlController::friction_getter, &lowctrl);
