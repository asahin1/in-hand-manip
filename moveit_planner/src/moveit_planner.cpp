...
namespace moveit_planner {  
  ...
  // Private
  void MoveitPlanner::waitForServices() {
    ROS_INFO("Waiting for service \"/move_group/goal\"");
    ros::service::waitForService("/move_group/goal");
    ROS_INFO("Service found, setting up moveit_planner_node");
  }
